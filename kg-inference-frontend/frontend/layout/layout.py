...
def to_be_filled(id_str): return html.Div(id=id_str, className="border-top px-2 py-4",
    ...
    html.Div(className="card mt-4", children=[
        ...
        html.Div(className="card-body", id="collapse_rule", children=html.Div([
            html.Div(className="col-xl-3 col-md-4 col-12", children=[
                ...
                html.H5(children="Search Data Generalization Rules:", style={"textAlign": "center"}),
            ...
            html.Div(className="col-xl-4 col-12", children=[
                html.H5(children="Selected Rule", id="selected_rule_title", style={"textAlign": "center"}),
        ...
        html.Div(className="card-body", id="collapse_result", children=html.Div([
            html.Div(children=[
                html.Div(className="col-xl-8 col-12", children=[
                    ...
                    dcc.Loading(id="result_fetching_loader", children=[html.Div(id="result_fetching_loader_output")],
                                type="circle"),
                ...
                html.Div(className="col-xl-4 col-12", children=[
                    html.H5(children="Selected Result", id="selected_result_title", style={"textAlign": "center"}),
                    dcc.Loading(id="selected_result_loader", children=[html.Div(id="selected_result_loader_output")],
                                type="circle"),
