...
def build_sidebar(brain_regions, data_types, cell_types, contributors):
    ...
    return [
        make_dropdown(label="By targeted data type", dropdown_id="datatype_dropdown",
                      values=data_types),
        make_dropdown(label="By brain region", dropdown_id="brain_region_dropdown",
                      values=brain_regions),
        make_dropdown(label="By cell type", dropdown_id="cell_type_dropdown",
                      values=cell_types),
        # make_dropdown(label="By contributor", dropdown_id="contributor_dropdown",
        # values=contributors),
